...
void MahonyAHRS::update_marg(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz) {
    float recipNorm;
...
void MahonyAHRS::update_imu(float gx, float gy, float gz, float ax, float ay, float az) {
    float recipNorm;
